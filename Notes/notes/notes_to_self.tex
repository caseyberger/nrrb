...
\begin{itemize}
	...
	\item Second complexify the observables. \note{Done: circulation (was already done), density, local density, field modulus, trap potential energy, real part of interaction potential energy. Remaining: imaginary part of interaction potential energy, angular momentum, total energy, kinetic energy}	
