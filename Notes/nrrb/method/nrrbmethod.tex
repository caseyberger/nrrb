...
%
\beq
S = \sum_{r}(S_{\mu, r}+d\tau S_{\del, r} - d\tau S_{tr, r} - d\tau S_{\omega, r}+ d\tau S_{\text{int}, r})
\eeq
%
with 
%
...
S_{\del, r} & = & \frac{d}{m} \phi^{*}_{r}\phi_{r} - \frac{1}{2m}\sum_{i =1}^{d}\phi^{*}_{r} \left(\phi_{r+\hat{i}}+\phi_{r-\hat{i}} \right) \\
S_{tr,r} & =& \frac{m}{2}\omega_{\text{trap}}^{2}(x^{2}+y^{2})\phi_{r}^{*}\phi_{r-\hat{\tau}}  \\
S_{\omega, r} & = &  i \omega_{z} \left[ (x-y)\phi_{r}^{*}  \phi_{r-\hat{\tau}} - x \phi_{r}^{*} \phi_{r-\hat{y}-\hat{\tau}} + y \phi_{r}^{*}  \phi_{r-\hat{x}-\hat{\tau}} \right] \\
...
%
\bea
x &=& a\left( n_{x}-\frac{N_{x}-1}{2} \right)\nonumber \\
y &=& a\left(n_{y}-\frac{N_{x}-1}{2}\right),\nonumber 
\eea
%
