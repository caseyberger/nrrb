...
%
\beq
S_{\text{lat}} = \sum_{\vec{x},\tau}a^{d}\left(S_{\tau,r} + S_{\del,r} - S_{\text{trap},r} - S_{\omega,r} + S_{\text{int},r}\right)
\eeq
%
with
%
...
%
\bea
S_{\tau,r} & =&\phi_{r}^{*}\phi_{r} - e^{ \bar{\mu}} \phi_{r}^{*}\phi_{r - \hat{\tau}} \nonumber\\
...
& =&  \frac{ \bar{\lambda}}{4}\left[ 
\phi_{1,r}\phi_{1,r-\hat{\tau}}(\phi_{1,r}\phi_{1,r-\hat{\tau}} +\phi_{2,r}\phi_{2,r-\hat{\tau}}) + \phi_{2,r}\phi_{2,r-\hat{\tau}}(\phi_{1,r}\phi_{1,r-\hat{\tau}} + \phi_{2,r}\phi_{2,r-\hat{\tau}})\right.\nonumber \\
&& \left.  
- \phi_{1,r}\phi_{1,r}\phi_{2,r-\hat{\tau}}\phi_{2,r-\hat{\tau}}-  \phi_{2,r}\phi_{2,r}\phi_{1,r-\hat{\tau}}\phi_{1,r-\hat{\tau}} \right.\nonumber \\
&& \left. 
+ \phi_{1,r}\phi_{2,r}\phi_{2,r-\hat{\tau}}\phi_{1,r-\hat{\tau}}  -  \phi_{2,r}\phi_{1,r}\phi_{1,r-\hat{\tau}}\phi_{2,r-\hat{\tau}} 
\right]\nonumber \\
&&+ i \frac{ \bar{\lambda}}{4} \left[
\phi_{1,r}\phi_{1,r-\hat{\tau}}\phi_{1,r}\phi_{2,r-\hat{\tau}} 
- \phi_{1,r}\phi_{1,r-\hat{\tau}}\phi_{2,r}\phi_{1,r-\hat{\tau}} 
\right.\nonumber \\
&& \left. 
- \phi_{2,r}\phi_{1,r-\hat{\tau}}\phi_{1,r}\phi_{1,r-\hat{\tau}} 
- \phi_{1,r}\phi_{1,r-\hat{\tau}}\phi_{2,r}\phi_{2,r-\hat{\tau}} 
\right.\nonumber \\
&& \left. 
+ \phi_{1,r}\phi_{2,r-\hat{\tau}}\phi_{1,r}\phi_{1,r-\hat{\tau}} 
+ \phi_{1,r}\phi_{2,r-\hat{\tau}}\phi_{2,r}\phi_{2,r-\hat{\tau}} 
\right.\nonumber \\
&& \left. 
- \phi_{2,r}\phi_{2,r-\hat{\tau}}\phi_{2,r}\phi_{1,r-\hat{\tau}} 
+ \phi_{2,r}\phi_{2,r-\hat{\tau}}\phi_{1,r}\phi_{2,r-\hat{\tau}} 
\right]\nonumber \\
